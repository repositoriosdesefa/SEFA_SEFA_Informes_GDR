...
# II.I Determinar el periodo comprendido en el informe ----
# Fecha actual
...
Este reporte[^1] contiene las metas correspondientes al equipo `r equipo` en el periodo comprendido entre el **`r day(Inicio_periodo)` de `r Mes_inicio` al `r day(Fin_mes)` de `r Mes_fin` de `r year(now())`**:
...
PORCENTAJE_LOGRADO_M1 <- paste0(round(logrado_1*100),"%")
